...
contract ErebrusSubscription is Context, AccessControl, ERC721 {
    ...
    string public activeTokenURI =
        "ipfs://bafybeidz3exqwxczrfezetyufh7cawsbbxb57y75xvyaschlxnbmm3d6m4";
    string public expiredTokenURI =
        "ipfs://bafybeih2uqq5tfpmrymgsni4jywxdncdin3nvpu4dl7o2bh3epetvkl6mm";
    ...
    constructor() ERC721("ErebrusSubscription", "ERBS") {
    ...
    function startSubscription() external {
        require(
            ...
            "ErebrusSubscription: Invalid address"
        );
        require(
