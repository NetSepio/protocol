...
export interface NetsepioInterface extends utils.Interface {
  contractName: "Netsepio";
  functions: {
...
export interface Netsepio extends BaseContract {
  contractName: "Netsepio";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NetsepioInterface;
