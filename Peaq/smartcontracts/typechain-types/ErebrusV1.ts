...
export interface ErebrusV1Interface extends utils.Interface {
  contractName: "ErebrusV1";
  functions: {
...
export interface ErebrusV1 extends BaseContract {
  contractName: "ErebrusV1";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ErebrusV1Interface;
